...
public class ConexaoOpenFinance{
    ...
    public ConexaoOpenFinance(Long id, String status, LocalDateTime dataCriacao, LocalDateTime dataExpiracaoToken, LocalDateTime ultimoSync, String pluggyItemId, InstituicaoFinanceira instituicaoFinanceira, Usuario usuario) {
        this.id = id;
        this.status = status;
    ...
    public static ConexaoOpenFinance novo(
            String status, LocalDateTime dataCriacao, LocalDateTime dataExpiracaoToken, LocalDateTime ultimoSync, String pluggyItemId, InstituicaoFinanceira instituicaoFinanceira, Usuario usuario

    ){
        return new ConexaoOpenFinance(null,status,dataCriacao,dataExpiracaoToken,ultimoSync,pluggyItemId,instituicaoFinanceira,usuario);
    }
