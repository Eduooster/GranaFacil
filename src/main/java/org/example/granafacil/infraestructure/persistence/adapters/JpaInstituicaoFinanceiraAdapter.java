...
public class JpaInstituicaoFinanceiraAdapter implements InstituicaoFinanceiraGateway {
    ...
    public void salvar(InstituicaoFinanceira instituicaoFinanceira) {
         ...
         instituicaoFinanceiraRepository.save(instituicaEntityMapper.toEntity(instituicaoFinanceira));
    }

    @Override
    public Optional<InstituicaoFinanceira> buscarPorIdConnector(Long connectorId) {
        Optional <InstituicaoFinanceira> instituicaoFinanceira = instituicaoFinanceiraRepository.findByIdConnector(connectorId).map(i-> instituicaEntityMapper.toDomain(i));
